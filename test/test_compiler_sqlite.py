...
class TestCompiler(unittest.TestCase):
    ...
    def setup_connection(self, db_name: str) -> Connection:
        # Reset database
        try:
            os.remove(db_name)
    ...
    def test_unary_rule(self):
        ...
        compiler = Compiler("sqlite", {"db": db_name}, program, 0)
        compiler.poll()
    ...
    def test_simple_binary_rule(self):
        ...
        compiler = Compiler("sqlite", {"db": db_name}, program)
        compiler.poll()
    ...
    def test_binary_rule_constants(self):
        ...
        compiler = Compiler("sqlite", {"db": db_name}, Program([rule]), 0)
        compiler.poll()
